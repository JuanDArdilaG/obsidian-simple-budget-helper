...
export class ScheduledItem extends Entity<Nanoid, ScheduledItemPrimitives> {
	...
	static fromPrimitives({
		...
		return new ScheduledItem(
			...
			brand || store
				? new ItemProductInfo({
						brand: brand ? new StringValueObject(brand) : undefined,
						store: store ? new StringValueObject(store) : undefined,
				  })
				: undefined,
