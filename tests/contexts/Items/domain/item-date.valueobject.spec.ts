...
describe("next", () => {
	...
	it("should calculate next date 4 years 2 months and 19 days later correctly", () => {
		const prevDate = new ItemDate(new Date(2024, 0, 1));
		const expectedDate = new ItemDate(new Date(2028, 2, 20));
	...
	it("should handle monthly recurrence with dates that don't exist in target month", () => {
		...
		const jan30 = new ItemDate(new Date(2024, 0, 30));
		const expectedFeb28 = new ItemDate(new Date(2024, 1, 29));
	...
	it("should handle monthly recurrence with dates that don't exist in target month - leap year", () => {
		...
		const jan30 = new ItemDate(new Date(2024, 0, 30));
		const expectedFeb29 = new ItemDate(new Date(2024, 1, 29));
	...
	it("should handle monthly recurrence with dates that don't exist in target month - non-leap year", () => {
		...
		const jan30 = new ItemDate(new Date(2023, 0, 30));
		const expectedFeb28 = new ItemDate(new Date(2023, 1, 28));
	...
	it("should handle monthly recurrence with March 31 -> April 30", () => {
		...
		const mar31 = new ItemDate(new Date(2024, 2, 31));
		const expectedApr30 = new ItemDate(new Date(2024, 3, 30));
	...
	it("should handle monthly recurrence with January 31 -> February 28 (non-leap year)", () => {
		...
		const jan31 = new ItemDate(new Date(2023, 0, 31));
		const expectedFeb28 = new ItemDate(new Date(2023, 1, 28));
	...
	it("should handle monthly recurrence with January 31 -> February 29 (leap year)", () => {
		...
		const jan31 = new ItemDate(new Date(2024, 0, 31));
		const expectedFeb29 = new ItemDate(new Date(2024, 1, 29));
	...
	it("should handle monthly recurrence with May 31 -> June 30", () => {
		// May 31 -> June 30
		const may31 = new ItemDate(new Date(2024, 4, 31));
		const expectedJun30 = new ItemDate(new Date(2024, 5, 30));
	...
	it("should handle monthly recurrence with July 31 -> August 31", () => {
		...
		const jul31 = new ItemDate(new Date(2024, 6, 31));
		const expectedAug31 = new ItemDate(new Date(2024, 7, 31));
	...
	it("should handle monthly recurrence with August 31 -> September 30", () => {
		...
		const aug31 = new ItemDate(new Date(2024, 7, 31));
		const expectedSep30 = new ItemDate(new Date(2024, 8, 30));
	...
	it("should handle monthly recurrence with October 31 -> November 30", () => {
		...
		const oct31 = new ItemDate(new Date(2024, 9, 31));
		const expectedNov30 = new ItemDate(new Date(2024, 10, 30));
	...
	it("should handle monthly recurrence with December 31 -> January 31", () => {
		...
		const dec31 = new ItemDate(new Date(2024, 11, 31));
		const expectedJan31 = new ItemDate(new Date(2025, 0, 31));
	...
	it("should handle monthly recurrence with February 29 -> March 29 (leap year)", () => {
		...
		const feb29 = new ItemDate(new Date(2024, 1, 29));
		const expectedMar29 = new ItemDate(new Date(2024, 2, 29));
	...
	it("should handle monthly recurrence with February 28 -> March 28 (non-leap year)", () => {
		...
		const feb28 = new ItemDate(new Date(2023, 1, 28));
		const expectedMar28 = new ItemDate(new Date(2023, 2, 28));
	...
	it("should handle multiple months addition with overflow", () => {
		...
		const jan31 = new ItemDate(new Date(2024, 0, 31));
		const expectedMar31 = new ItemDate(new Date(2024, 2, 31));
	...
	it("should handle year boundary with monthly recurrence", () => {
		...
		const dec31 = new ItemDate(new Date(2023, 11, 31));
		const expectedJan31 = new ItemDate(new Date(2024, 0, 31));
	...
	it("should handle leap year boundary with monthly recurrence", () => {
		...
		const jan31_2023 = new ItemDate(new Date(2023, 0, 31));
		const expectedFeb28_2023 = new ItemDate(new Date(2023, 1, 28));
	...
	it("should handle leap year boundary with monthly recurrence - leap year", () => {
		...
		const jan31_2024 = new ItemDate(new Date(2024, 0, 31));
		const expectedFeb29_2024 = new ItemDate(new Date(2024, 1, 29));
	...
	it("should handle complex frequency with months and days", () => {
		...
		const jan31 = new ItemDate(new Date(2024, 0, 31));
		const expectedMar5 = new ItemDate(new Date(2024, 2, 5));
	...
	it("should handle complex frequency with years, months and days", () => {
		...
		const jan31_2024 = new ItemDate(new Date(2024, 0, 31));
		const expectedMar5_2025 = new ItemDate(new Date(2025, 2, 5));
	...
	it("should handle edge case with February 29 in leap year", () => {
		...
		const feb29_2024 = new ItemDate(new Date(2024, 1, 29));
		const expectedMar29_2024 = new ItemDate(new Date(2024, 2, 29));
	...
	it("should handle edge case with February 28 in non-leap year", () => {
		...
		const feb28_2023 = new ItemDate(new Date(2023, 1, 28));
		const expectedMar28_2023 = new ItemDate(new Date(2023, 2, 28));
	...
	it("should handle edge case with February 29 + 1 year in leap year", () => {
		...
		const feb29_2024 = new ItemDate(new Date(2024, 1, 29));
		const expectedMar1_2025 = new ItemDate(new Date(2025, 2, 1));
	...
	it("should handle edge case with February 28 + 1 year in non-leap year", () => {
		...
		const feb28_2023 = new ItemDate(new Date(2023, 1, 28));
		const expectedFeb28_2024 = new ItemDate(new Date(2024, 1, 28));
